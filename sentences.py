input_text = """
    ...
    Сіз тапсырманы неге орындамадыңыз?
...
additional_text = """
Вы не устали?
Вы недостаточио прилежно работаете,
Вы немного опоздали.
Вы опытный человек.
...
kaz_line = lines + translated_sentences
rus_line = additional_lines + original_sentences
print(len(kaz_line), len(rus_line))
